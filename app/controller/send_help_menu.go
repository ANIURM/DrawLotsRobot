...
func p2pHelpMenu(messageevent *model.MessageEvent) {
	...
	global.Feishu.MessageSend(feishuapi.UserOpenId, open_id, feishuapi.Text, "your user_id is: "+user_id+" , and your open_id is: "+open_id)
}

func GroupHelpMenu(messageevent *model.MessageEvent) {
	groupID := messageevent.Message.Chat_id
	global.Feishu.MessageSend(feishuapi.GroupChatId, groupID, feishuapi.Text, "your groupID is: "+groupID)
}
