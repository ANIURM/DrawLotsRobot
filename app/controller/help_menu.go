...
func p2pHelpMenu(messageevent *chat.MessageEvent) {
	...
	global.Cli.Send(feishuapi.UserOpenId,open_id, "text", "your user_id is: " + user_id + " , and your open_id is: " + open_id)
}

func GroupHelpMenu(messageevent *chat.MessageEvent) {
	groupID := messageevent.Message.Chat_id
	global.Cli.Send(feishuapi.GroupChatId, groupID, "text", "your groupID is: " + groupID)
}